  ...
  return (
    <div className={`flex w-full max-w-full overflow-x-hidden bg-primary-50 font-outfit text-ink ${isClient ? 'min-h-screen' : 'min-h-screen md:h-screen md:overflow-hidden flex-col md:flex-row'}`}>
      ...
      <div className="flex-1 flex flex-col relative min-w-0">
        ...
        {/* Zona de Contenido */}
        <main className={`flex-1 relative z-10 w-full max-w-full ${isClient ? 'overflow-y-auto overflow-x-hidden' : 'overflow-x-hidden md:overflow-y-auto p-3 sm:p-4 md:p-8 lg:p-12 scrollbar-hide'}`} style={isClient ? { WebkitOverflowScrolling: 'touch' } : undefined}>
          {/* Background Accents */}
