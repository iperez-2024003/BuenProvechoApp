...
/**
 * @swagger
 * /api/v1/auth/profile/redeem-points:
 *   post:
 *     tags: [Profile]
 *     summary: Canjea puntos del usuario
 */
router.post(
  '/profile/redeem-points',
  validateJWT,
  authController.redeemPoints
);

/**
 * @swagger
 * /api/v1/auth/profile/add-points:
 *   post:
 *     tags: [Profile]
 *     summary: Agrega puntos al usuario
 */
router.post(
  '/profile/add-points',
  validateJWT,
  authController.addPoints
);
